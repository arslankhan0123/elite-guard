                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select" id="tag_type" name="type" required>
                                <option value="" disabled {{ old('type', $nfcTag->type) == '' ? 'selected' : '' }}>Select...</option>
                                <option value="nfc" {{ old('type', $nfcTag->type) == 'nfc' ? 'selected' : '' }}>NFC</option>
                                <option value="image" {{ old('type', $nfcTag->type) == 'image' ? 'selected' : '' }}>Image</option>
                                <option value="both" {{ old('type', $nfcTag->type) == 'both' ? 'selected' : '' }}>NFC + Image</option>
                            </select>
