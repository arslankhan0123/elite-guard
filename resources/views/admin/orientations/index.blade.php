...
@section('title', 'Orientation Listing')

@section('breadcrumbTitle', 'Orientation Listing')
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header justify-content-between d-flex align-items-center">
                    <h4 class="card-title shine">Orientation Table</h4>
                    <a href="{{route('orientations.create')}}" class="btn btn-sm btn-info">Create <i
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="custom-table" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                @foreach($orientations['orientations'] as $orientation)
                                    <tr>
                                        <td>{{ $orientation->id }}</td>
                                        <td>{{ $orientation->type }}</td>
                                        <td>
                                            @if($orientation->document)
                                                <a href="{{ $orientation->document }}" target="_blank"
                                                    class="btn btn-sm btn-soft-primary">
                                                    <i class="mdi mdi-file-document-outline"></i> View Document
                                                </a>
                                            @else
