...
@section('breadcrumbTitle', 'Number Edit')
    ...
    <div class="col-xl-12">
        <div class="card card-h-100">
            <div class="card-header justify-content-between d-flex align-items-center">
                <h4 class="card-title">Number Edit</h4>
                ...
                <form action="{{ route('numbers.update', $number->id) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="number_with_code" class="form-control" value="{{ old('number_with_code', $number->number_with_code) }}" placeholder="e.g. +92123456789">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="type" class="form-select">
                                ...
                                <option value="Website" {{ old('type', $number->type) == 'Website' ? 'selected' : '' }}>Website</option>
                                <option value="Application" {{ old('type', $number->type) == 'Application' ? 'selected' : '' }}>Application</option>
                                <option value="Footer/Header" {{ old('type', $number->type) == 'Footer/Header' ? 'selected' : '' }}>Footer/Header</option>
                                <option value="Other" {{ old('type', $number->type) == 'Other' ? 'selected' : '' }}>Other</option>
                            </select>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="status" class="form-select" required>
                                <option value="1" {{ old('status', $number->status) == '1' ? 'selected' : '' }}>Active</option>
                                <option value="0" {{ old('status', $number->status) == '0' ? 'selected' : '' }}>Inactive</option>
                            </select>
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <button type="submit" class="btn btn-primary px-4">Update Number</button>
