                            ...
                            <div class="col-md-4 mb-3 d-flex flex-column">
                                ...
                                <select name="date_range" id="date_range" class="form-select" onchange="this.form.submit()">
                                    ...
                                    <option value="yesterday" {{ request('date_range') == 'yesterday' ? 'selected' : '' }}>
                                        Yesterday</option>
                                    <option value="current_week" {{ request('date_range') == 'current_week' ? 'selected' : '' }}>
                                        Current Week</option>
                                    ...
                                    <option value="last_month" {{ request('date_range') == 'last_month' ? 'selected' : '' }}>Last
                                        Month</option>
                                    <option value="current_year" {{ request('date_range') == 'current_year' ? 'selected' : '' }}>
                                        Current Year</option>
                            ...
                            @if($type == 'vehicle-checklist')
                                <div class="col-md-4 mb-3 d-flex flex-column">
                                    ...
                                    <select name="document_status" id="document_status" class="form-select"
                                        ...
                                        <option value="uploaded" {{ request('document_status') == 'uploaded' ? 'selected' : '' }}>
                                            Uploaded</option>
