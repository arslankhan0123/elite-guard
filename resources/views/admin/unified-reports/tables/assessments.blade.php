        ...
        @forelse($data['assessments'] as $assessment)
            ...
            <td>
                <div class="d-flex align-items-center">
                    <a class="text-decoration-none text-dark me-2" href="{{ route('reports.show', ['type' => $type, 'id' => $assessment->id]) }}" data-bs-toggle="tooltip" title="View Details">
                        <button class="view_btn"></button>
                    </a>
                    <a class="text-decoration-none text-dark me-2" href="{{ route('reports.edit', ['type' => $type, 'id' => $assessment->id]) }}" data-bs-toggle="tooltip" title="Edit">
                    ...
                    <a class="text-decoration-none text-dark" href="{{ route('reports.download', ['type' => $type, 'id' => $assessment->id]) }}" data-bs-toggle="tooltip" title="Download PDF">
