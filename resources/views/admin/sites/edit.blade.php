                    ...
                    <div class="row mt-3">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" step="1" min="0" name="interval" class="form-control"
                                   value="{{ old('interval', $site->interval) }}" placeholder="e.g. 45" required>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" step="1" min="0" name="open_time" class="form-control"
                                   value="{{ old('open_time', $site->open_time) }}" placeholder="e.g. 45" required>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" step="1" min="0" name="grace_time" class="form-control"
                                   value="{{ old('grace_time', $site->grace_time) }}" placeholder="e.g. 45" required>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-5 mb-3">
                            ...
                            <input type="number" step="any" name="latitude" id="edit_latitude"
                                   class="form-control" value="{{ old('latitude', $site->latitude) }}"
                        ...
                        <div class="col-md-5 mb-3">
                            ...
                            <input type="number" step="any" name="longitude" id="edit_longitude"
                                   class="form-control" value="{{ old('longitude', $site->longitude) }}"
                        ...
                        <div class="col-md-2 mb-3 d-flex align-items-end">
                            <button type="button"
                                    ...
                                    onclick="getCurrentLocation('edit_latitude','edit_longitude','edit_location_status')">
                                <i class="mdi mdi-crosshairs-gps me-1"></i> My Location
                            </button>
                        </div>
                    </div>
                    <div id="edit_location_status" class="text-muted small mb-3" style="display:none;"></div>
